...
def main():
    ...
    parser.add_argument('--config', type=str, default='configs/kspace_mask_augment.yaml',
    ...
    print(f"Augmentor config: hflip={augmentor.base_prob_hflip}, vflip={augmentor.base_prob_vflip}, "
          f"max_shift={augmentor.max_shift_fraction}")
    # "shift={augmentor.prob_shift},
    # Load sample data
